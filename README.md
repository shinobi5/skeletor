...
+ The script also runs `scripts/build-registry.js` which imports and registers the component in `src/component-registry.js`. The barebones component is now ready to use e.g. `<x-mycomponent>I'm alive!</x-mycomponent>`
