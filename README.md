...
+ Import component in `src/app.js` e.g. `import component from './js/components/component/component';`
+ After the `import` register the component in `src/app.js` e.g. `customElements.define('x-component', component);`
