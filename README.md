...
[router-component](https://github.com/mkay581/router-component) and [beedle](https://github.com/andybelldesign/beedle) are recommended for adding SPA features to the boilerplate because they're lightweight and framework agnostic (using and inspired by web components).
