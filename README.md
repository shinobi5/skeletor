...
[Haunted](https://github.com/matthewp/haunted) provides internal component state management (same as the [react hooks](https://reactjs.org/docs/hooks-reference.html)).
