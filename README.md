...
Deno has a bundler that works out of the box but clearly it must be intended for producing backend bundles. The resulting frontend SystemJS bundled file produced by the internal bundler is massive and not at all suitable for production builds.
