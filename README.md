...
A service worker and webmanifest are included for basic PWA features. For SPAs a lightweight web component router ([router-component](https://github.com/mkay581/router-component)) is included while [redux](https://github.com/reduxjs/redux) is included for managing state.
